...
** Primary reference
B. S. Grandey, D. Rothenberg, A. Avramov, Q. Jin, H.-H. Lee, X. Liu, Z. Lu, S. Albani, and C. Wang (submitted), "Effective radiative forcing in the aerosol-climate model CAM5.3-MARC-ARG". A preprint is available via arXiv: http://arxiv.org/abs/1804.06158.
