...
** Status
***** DONE Design and finalize =user_nl_cam= files for *comparison* simulations
CLOSED: [2017-07-21 Fri 11:25]
***** TODO Design and finalize configuration (in =configure_simulations.org=) of *comparison* simulations
