...
# lz4ax 2014/02/05
# 2017-07-07 - modified by BSG to produce year-2000 sulphate emissions.

#where MAM3 files live
set mam3dir = /glade/p/cesmdata/cseg/inputdata/atm/cam/chem/trop_mozart_aero/emis/

#MAM3 emission files
#set mam3SO2sfc  = $mam3dir/ar5_mam3_so2_surf_2000_c090726.nc
#set mam3SO2lev  = $mam3dir/ar5_mam3_so2_elev_2000_c090726.nc
set mam3SO4sfc1 = $mam3dir/ar5_mam3_so4_a1_surf_2000_c090726.nc
set mam3SO4sfc2 = $mam3dir/ar5_mam3_so4_a2_surf_2000_c090726.nc
set mam3SO4lev1 = $mam3dir/ar5_mam3_so4_a1_elev_2000_c090726.nc
set mam3SO4lev2 = $mam3dir/ar5_mam3_so4_a2_elev_2000_c090726.nc

#MITaer filenames
#set SO2SFCFILE = mit_aero_2000_so2_surf_1.9x2.5.nc
#set SO2LEVFILE = mit_aero_2000_so2_elev_1.9x2.5.nc
set SO4SFCFILE = mit_aero_2000_so4_surf_1.9x2.5.nc
set SO4LEVFILE = mit_aero_2000_so4_elev_1.9x2.5.nc
